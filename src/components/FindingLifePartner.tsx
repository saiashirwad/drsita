...
const FindingLifePartner: Component = () => {
  ...
  return (
    <form onSubmit={handleSubmit} class="space-y-8">
      ...
      <div class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <input
              ...
              class="w-full px-4 py-2 rounded-lg bg-surface/50 border border-highlight-med/10 focus:border-highlight-med/20 outline-none"
              value={formData().age}
              onInput={(e) => setFormData(prev => ({ ...prev, age: e.currentTarget.value }))}
            />
          </div>
        </div>
        ...
        <div>
          ...
          <select
            class="w-full px-4 py-2 rounded-lg bg-surface/50 border border-highlight-med/10 focus:border-highlight-med/20 outline-none"
            value={formData().sex}
            onChange={(e) => setFormData(prev => ({ ...prev, sex: e.currentTarget.value }))}
            required
          >
      ...
      <div class="space-y-6">
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => setFormData(prev => ({ ...prev, duration: e.currentTarget.value }))}
          >
            <option value="">Select...</option>
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => setFormData(prev => ({ ...prev, timing: e.currentTarget.value }))}
          >
            <option value="">Select...</option>
      ...
      <div class="space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            onInput={(e) => setFormData(prev => ({ ...prev, specificQuestions: e.currentTarget.value }))}
          />
        </div>
      </div>
      ...
      {submitStatus() === 'error' && (
        <p class="text-love text-center">There was an error submitting your response. Please try again.</p>
      )}
    </form>
  );
};
