...
export const testimonials: Testimonial[] = [
  ...
  {
    id: 5,
    quote: "We were facing problems due to vaginismus in our life even after 2 years of our marriage and then we came to know about the admission treatment offered by Dr.Sita which helped us a lot to cure the problem and also the group sessions helped us a lot to improve our relationship. Dr Ramu sir is such a kind person, he always helps us with any issues during our batch therapy. Thank you for providing such an effective treatment for this problem.",
    author: "Jaseem A",
    program: "Samyojana Therapy",
    rating: 5,
    category: "couples",
  ...
  {
    id: 10,
    quote: "A great institution that made our life meaningful, joyful and taught me to lead a healthy and disciplined life.",
  ...
  {
    id: 11,
    quote: "Best experience in our life. Thanks for everyone and everything to become our life meaningful. Will always remember the quotes which strike in my mind 'The home where you will be very comfortable and happy'. Mark my words You will be never disappointed once you consulted here.",
  ...
  {
    id: 13,
    quote: "I was recently treated in Devikripa Hospital for few days. I am pleased to comment that the hospital and its staff, including the doctors (Dr.Sita and Dr. Ramu), nurses, and other personnel, provided exceptionally supportive and effective care. As a result, my condition has been fully resolved. Thank you so much.",
  ...
  {
    id: 14,
    quote: "A very good experience 100% honestly... Dr. Seethalakshmi who lifted her hand to a new life from when she thought that all hope was over. Heartfelt thanks to Ramachandran and the nursing staff at Devikripa Hospital....",
